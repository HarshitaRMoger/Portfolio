...
const Skills = () => {
  ...
  const frontendSkills = [
    ...
    { skill: 'java', level: 80, color: 'bg-blue-500' },
    { skill: 'HTML & CSS', level: 96, color: 'bg-orange-500' },
  ];

  const toolsSkills = [
    { skill: 'Tableau', level: 88, color: 'bg-teal-500' },
    { skill: 'Git & GitHub', level: 85, color: 'bg-gray-800' },
    { skill: 'Webpack/Vite', level: 75, color: 'bg-purple-600' },
    { skill: 'Docker', level: 65, color: 'bg-blue-400' },
  ];
