          ...
          <div className="flex flex-col md:flex-row gap-8">
            <div className="md:w-1/3">
              <div className="bg-indigo-100 dark:bg-indigo-900/30 h-60 rounded-lg flex items-center justify-center mb-4">
                {<img src="c:\Users\harsh\OneDrive\Desktop\photo.jpg" alt="Developer" className="w-full h-full object-cover" /> }
              ...
              <div className="text-center">
                <h3 className="font-bold text-lg text-gray-800 dark:text-white">Harshita Ramakrishna Moger</h3>
            ...
            <div className="md:w-2/3">
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                I'm a passionate Frontend Developer with a strong foundation in React, TypeScript, and modern CSS frameworks. My journey in web development began 2 years ago, and I've been crafting engaging digital experiences ever since.
              </p>
